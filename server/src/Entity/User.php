...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    private Collection $ownerProjects;
    ...
    public function addOwnerProject(Project $ownerProject): static
    {
    ...
    public function removeOwnerProject(Project $ownerProject): static
    {
        if ($this->ownerProjects->removeElement($ownerProject)) {
